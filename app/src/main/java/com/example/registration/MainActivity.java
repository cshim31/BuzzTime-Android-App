...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //fragmentTraction.replace(R.id.relativeLayout, new CourseFragment());
        ...
        scheduleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //fragmentTraction.replace(R.id.relativeLayout, new ScheduleFragment());
                fragmentTraction.commit();
            }
        });
        statisticsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // fragmentTraction.replace(R.id.relativeLayout, new StatisticsFragment());
                fragmentTraction.commit();
            }
        });
    ...
    class AnnouncementTask extends AsyncTask {
        ...
        protected void onPreExecute() {
            address = "http://sch1261315.cafe24.com/AnnouncementList.php";
        }
